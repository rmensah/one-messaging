...
app.controller('loginButtonsController', ['$userService','$http','$window', function($userService, $http, $window){
  ...
  lBC.changeGmailStatus = function(){
    ...
    if(lBC.gmailLoginStatus === "gmail log out"){
      ...
      $window.open("https://accounts.google.com/o/oauth2/auth?access_type=offline&scope=https://www.googleapis.com/auth/gmail.readonly&response_type=token&client_id="+"984356963831-0pfq9l1t3mnnlr0i2lec28pmvdhdmm2k.apps.googleusercontent.com&state="+$userService.user.username+"&redirect_uri=https://fast-gorge-90415.herokuapp.com/gmailAuth","_self");
